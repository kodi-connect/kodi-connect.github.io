...
* Download newest addon version [here](https://kodi-connect.s3.eu-central-1.amazonaws.com/kodi-connect-addon/3.0.0/plugin.video.kodiconnect-0.3.5.zip)
...
1. After signing in, you will be redirected back to Kodi Connect page, with a single button "Create skill".
1. Press it, and wait until "empty" Skill is created, and skill ID is presented.
...
1. Go back to the page from "Part 1", or if you've closed it, [Kodi Connect - Alexa Skill](https://kodiconnect.kislan.sk/alexa-skill) page
1. Here enter the Lambda function ARN, that you've or you can copy from the AWS page, where you've created it (`arn:aws:lambda:<region_you_picked>:<long_number>:function:kodi`), and press "Link Lambda" button
1. Give it a few seconds, and it will update the skill to be ready for use.
